...
.signUpButton {
   ...
   border-radius: 5px;
   cursor: pointer;
   -webkit-box-shadow: inset 0 -2px #9acd32;
...
<body>
<form class="signUp" id="signupForm" method="post" action="logincheck.php">
	<img src=img/helmet.jpg style="max-width: 400px; height: 80px; alt:"/>
   <input type="text" name="id" class="signUpInput" placeholder="아이디를 입력하세요." autofocus required>
   <input type="password" name="pwd" class="signUpInput" placeholder="비밀번호를 입력하세요." required>
	 <div class="forgot">
           <a href="/member/find/loginId" class="link_find">아이디 찾기</a>
					 /
